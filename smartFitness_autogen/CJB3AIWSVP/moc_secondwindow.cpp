...
QT_MOC_LITERAL(1, 13, 17), // "send_after_second"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 24), // "on_SecondWindow_finished"
...
QT_MOC_LITERAL(7, 110, 23) // "on_pushButton_3_clicked"
    ...
    "SecondWindow\0send_after_second\0\0"
    "on_SecondWindow_finished\0result\0"
...
void SecondWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send_after_second(); break;
        case 1: _t->on_SecondWindow_finished((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SecondWindow::send_after_second)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SecondWindow::send_after_second()
{
